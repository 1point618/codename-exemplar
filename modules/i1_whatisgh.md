...
![Label and Assigning Tutorial](https://github.com/1point618/codename-exemplar/blob/master/img/label-assign.png?raw=true)
...
There's one more thing to learn about Issues, then we can move on. Close this issue below, then click on the Issues icon \(![Issue Icon](https://github.com/1point618/codename-exemplar/blob/master/img/issue-icon.png?raw=true)\) to the right to get to the "Issues View", then click through to the issue named **Lesson 2: Managing Issues**.